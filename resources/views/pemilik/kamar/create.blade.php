                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                      ...
                      <select name="kategori" class="form-control @error('kategori') is-invalid @enderror">
                          ...
                          <option value="Kost Pribadi" {{old('kategori') == 'Kost Pribadi' ? 'selected' : ''}} >Kost Pribadi</option>
                          <option value="Kost Sharing" {{old('kategori') == 'Kost Sharing' ? 'selected' : ''}}>Kost Sharing</option>
                      </select>
                      @error('kategori')
                        <div class="invalid-feedback">
                          <strong>{{ $message }}</strong>
