      ...
      <div class="card">
        <div class="card-content">
          ...
          <div class="card-img-overlay overflow-hidden overlay-danger overlay-lighten-2">
            ...
            <p class="card-text"><small class="text-white">Posted by Kost Astoria</small></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-content">
          ...
          <div class="card-img-overlay overflow-hidden overlay-warning overlay-lighten-2">
            <h4 class="card-title text-white">Ngekost?? Hanya di Kost Astoria Aja.</h4>
            <p class="card-text text-white">Cari kamar terbaik di madiun yang nyaman hanya di Kost Astoria.
            </p>
            <p class="card-text"><small class="text-white">Posted by Kost Astoria</small></p>
          </div>
        </div>
