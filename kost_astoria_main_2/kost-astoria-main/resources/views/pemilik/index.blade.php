...
<div class="card-header">
    ...
    <div class="d-flex align-items-center">
        <p class="card-text font-small-2 mr-25 mb-0">Cetak Laporan Keuangan</p>

        <!-- Select untuk Export PDF -->
        <select class="custom-outline-select ml-1" onchange="exportLaporanKeuangan(this)">
...
.custom-outline-select option {
    ...
    <script>
    function exportLaporanKeuangan(select) {
        const periode = select.value;
        if (periode) {
            const url = `/export-pendapatan/${periode}`;
