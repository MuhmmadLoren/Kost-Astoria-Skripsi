        ...
        <div class="d-flex justify-content-between">
          ...
          <div class="d-flex flex-column gap-3">
            ...
            <div>
              ...
              <a href=" {{asset('storage/images/bukti_bayar/' .$confirm->payment->bukti_bayar)}}" target="_blank" class="btn btn-info btn-md">
                <i class="feather icon-file"></i> File Bukti Bayar</a>
              </div>
              <div>
                <a href=" {{asset('storage/images/bukti_selfie/' .$confirm->payment->foto_selfie)}}" target="_blank" class="btn btn-success btn-md mt-1">
                  <i class="feather icon-file"></i> File Bukti Selfie</a>
