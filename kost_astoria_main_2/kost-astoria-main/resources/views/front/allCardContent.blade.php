...
@section('description')
  Kost Astoria, aplikasi yang dikhususkan untuk kos astoria madiun.
@endsection
@section('title')
    ...
    <div class="search-bar">
      <form action="{{url('show-all-room')}}" method="GET">
        <fieldset class="form-group position-relative has-icon-left">
          <input type="text" class="form-control round" name="cari" id="searchbar" placeholder="Masukan Nama Kos...">
