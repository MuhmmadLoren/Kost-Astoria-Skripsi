...
Route::middleware('auth')->group(function () {
  ...
  Route::get('/export-pendapatan/{periode}', 'HomeController@exportPendapatanPDF')
    ->name('pendapatan.export');//export laporan keuangan
  ...
  Route::prefix('pemilik')->middleware('role:Pemilik')->group(function () {
    ...
    Route::get('payment','Owner\PaymentController@payment')->name('laporan-pembayaran'); // Payment Index
    Route::get('export-pembayaran-pdf', 'Owner\PaymentController@exportPDF')->name('laporan-pembayaran.export');// Cetak Pdf Payment
  });
